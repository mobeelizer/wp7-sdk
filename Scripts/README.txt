...
Ready-to-use version of the Mobeelizer SDK framework is deployed at http://sdk.mobeelizer.com/mobeelizer-wp7-sdk.zip
...
Silverlight SharpZipLib license:
	- http://slsharpziplib.codeplex.com/license
	
Configuration.dll is part of "patterns & practices: Mobile Application Blocks - Community Release" library:
